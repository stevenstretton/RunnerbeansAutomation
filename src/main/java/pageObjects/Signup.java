...
public class Signup {
    ...
    {
        WebElement formFirstname = driver.findElement(By.xpath("html/body/app-root/div[2]/app-signup/div/div[2]/div" +
                "/div/form/fieldset/div[1]/div/input"));
    ...
    {
        WebElement formSurname = driver.findElement(By.xpath("html/body/app-root/div[2]/app-signup/div/div[2]/div" +
                "/div/form/fieldset/div[2]/div/input"));
    ...
    {
        WebElement formEmail = driver.findElement(By.xpath("html/body/app-root/div[2]/app-signup/div/div[2]/div/" +
                "div/form/fieldset/div[3]/div/input"));
    ...
    {
        WebElement formPassword = driver.findElement(By.xpath("html/body/app-root/div[2]/app-signup/div/div[2]/div/" +
                "div/form/fieldset/div[4]/div/input"));
